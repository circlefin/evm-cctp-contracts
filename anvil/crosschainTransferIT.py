...
class TestTokenMessengerWithUSDC(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.eth_token_minter = self.deploy_contract_from_source('src/TokenMinter.sol', 'TokenMinter', caller="eth_token_minter_deployer")
        ...
        self.avax_token_minter = self.deploy_contract_from_source('src/TokenMinter.sol', 'TokenMinter', caller="avax_token_minter_deployer")
        ...
        self.send_transaction(self.eth_token_minter.functions.setLocalTokenEnabledStatus(self.eth_usdc.address, True), "eth_token_minter_deployer")
        self.send_transaction(self.avax_token_minter.functions.setLocalTokenEnabledStatus(self.avax_usdc.address, True), "avax_token_minter_deployer")

        # linkTokenPair
        self.send_transaction(self.eth_token_minter.functions.linkTokenPair(self.eth_usdc.address, avax_domain, self.to_32byte_hex(self.avax_usdc.address)), "eth_token_minter_deployer")
        self.send_transaction(self.avax_token_minter.functions.linkTokenPair(self.avax_usdc.address, eth_domain, self.to_32byte_hex(self.eth_usdc.address)), "avax_token_minter_deployer")
